...
const Home = () => {
  return (
    <section id="home" className="min-h-screen  bg-white text-blue-950 flex items-center">
      <div className="container mx-auto px-4 text-center">
        <h1 className="text-4xl md:text-4xl font-bold mb-6">Welcome! I'm Rimfat Timnan Simon</h1>
        ...
        <a href="#projects" className="mt-8 inline-block bg-blue-900 text-white px-6 py-3 rounded-full text-lg font-semibold hover:bg-[#FFC107] hover:text-[#2C2F33] transition duration-300">
          Explore My Work
        </a>
      </div>
    </section>
